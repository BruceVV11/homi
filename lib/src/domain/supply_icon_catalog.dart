...
abstract final class SupplyIconCatalog {
  ...
  static const List<SupplyIconOption> all = <SupplyIconOption>[
    ...
    SupplyIconOption('dishwasher', 'Dishwashing', Icons.kitchen_outlined),
    ...
    SupplyIconOption('nappies', 'Nappies', Icons.baby_changing_station),
    ...
    SupplyIconOption('candles', 'Candles', Icons.light_mode_outlined),
